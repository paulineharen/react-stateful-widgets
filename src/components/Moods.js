...
STEP 1:
  ...
  The 'mood' slice of state should be initialized to one of the three variables
...
//   STEPS 4, 5, 6:
//   Inside these click handlers set the correct mood, using 'setMood' and the
//  variables below the imports.
// */
